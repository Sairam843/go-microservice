...
type NewUserInput struct {
	...
	PreferredName string                 `protobuf:"bytes,1,opt,name=preferred_name,json=preferredName,proto3" json:"preferred_name,omitempty"`
...
func (x *NewUserInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NewUserInput) ProtoMessage() {}

func (x *NewUserInput) ProtoReflect() protoreflect.Message {
	mi := &file_signup_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use NewUserInput.ProtoReflect.Descriptor instead.
func (*NewUserInput) Descriptor() ([]byte, []int) {
	return file_signup_proto_rawDescGZIP(), []int{0}
}

func (x *NewUserInput) GetPreferredName() string {
	if x != nil {
...
func (x *NewUserInput) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *NewUserInput) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
const file_signup_proto_rawDesc = "" +
	"\n" +
	"\fsignup.proto\x12\x04user\"g\n" +
	"\fNewUserInput\x12%\n" +
	"\x0epreferred_name\x18\x01 \x01(\tR\rpreferredName\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpasswordB\x03Z\x01.b\x06proto3"
